...
Java_cz_civilizacehra_sifrohaluzic_MrizkoDrticActivity_grindGrid(JNIEnv *env, jobject /* this */, jstring input) {
...
Java_cz_civilizacehra_sifrohaluzic_MrizkoDrticActivity_initializeTrie(JNIEnv* env, jclass clazz, jobject assetManager)
{
